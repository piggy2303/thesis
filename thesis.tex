...
Ở chương này, báo cáo sẽ trình về quá trình thực nghiệm và triển khai với các thư viện hỗ trợ tiền xử lý mã nguồn như Java Development Tools \footnote{https://www.eclipse.org/jdt} hay DOMParser và SAXParser. Thêm vào đó công cụ phát triển cũng được mô tả chi tiết triển khai cho các phương pháp đã nêu ở các chương trước.
